<template>
  <div class="flex flex-wrap bg-green-600">
    <div class="max-w-screen-xl mx-auto py-3 px-3 sm:px-6 lg:px-8">
      <div class="pr-16 sm:text-center sm:px-16">
        <p class="font-medium text-white">
          <span class="md:hidden">
            Succès de l'ajout de température
          </span>
          <span class="hidden md:inline">
            Succès de l'ajout de température
          </span>
          <span
            class="block sm:ml-2 sm:inline-block text-gray-900 hover:underline"
          >
            <nuxt-link to="/temperatures">
              Voir toutes les températures &rarr;
            </nuxt-link>
          </span>
        </p>
      </div>
